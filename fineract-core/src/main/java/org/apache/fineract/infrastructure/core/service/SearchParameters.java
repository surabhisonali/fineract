...
public final class SearchParameters {
    ...
    private SearchParameters(final String sqlSearch, final Long officeId, final String externalId, final String name,     
          ...
          final Integer limit, final String orderBy, final String sortOrder, final Long staffId, final String accountNo,
          final Long loanId, final Long savingsId, final Boolean orphansOnly, boolean isSelfUser,                       
          final Integer birthdayMonth, final Integer birthdayDay) {                                                     
        this.sqlSearch = sqlSearch;
        this.officeId = officeId;                                                                                         
        this.externalId = externalId;                                                                                     
        this.name = name;
    ...
    public boolean isBirthdayMonthPassed() {
        return this.birthdayMonth != null;
    }

    public boolean isBirthdayDayPassed() {
        return this.birthdayDay != null;
    }
